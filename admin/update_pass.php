          ...
          <div class="w3-container w3-blue w3-padding-16">
            ...
            <a href="#" onclick="loadDoc1()"><h4>Change Password</h4></a> 
                  ...
                  if (isset($_POST['submit'])) {
                    ...
                    $sql = "UPDATE tbl_user SET `password`='$upass' WHERE `user_id`='$user_id'";
                ...
                while($row = mysqli_fetch_array($result)) {
                      ...
                      echo "<td>  <form action='' method='POST'>
                                    <input  type='text' name='upass' placeholder='Update Pass..'>  </td>";
                       echo "<td> <a  class='btn btn-primary' name='submit' href=update_pass.php?id=".$row["user_id"].">Update Password</a> </td>"; 
