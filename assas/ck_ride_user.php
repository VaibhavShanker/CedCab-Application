        ...
        <div class="container-fluid section2a" style="background: none;padding-top: 0px;">
            ...
            <div class="container">
                  <div class="dropdown">
                      ...
                      <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                      <li role="presentation"><a role="menuitem" tabindex="-1" href=./update_deteals.php?id=".$row['user_id'].'" onclick="loadDoc1()">Date</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="#" onclick="loadDoc2()">Fear</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="#" onclick="loadDoc3()">Distance</a></li>
                        <li role="presentation" class="divider"></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="../user_panel/all_ride_user.php">All Rides</a></li>   
                      </ul>
                  </div><br>
