                            ...
                            <form action="" method="POST">
                                ...
                                <div class="col-auto" style="width: 550px;">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <?php
                                            ...
                                            $result = $con->query($sql);                                            
                                        ?>                                                   
                                            <select name="drop" class="form-control" id="select1" placeholder="Enter drop for ride estimate">               
                                ...
                                <div id="cab" class="col-auto" style="width: 550px;">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <select name="cab" class="form-control" id="select3"
                                           ...
                                           <?php echo '<option value="'.$_SESSION['ct'].'" selected>'.$_SESSION['ct'].'</option>'; ?>
                                ...
                                <div class="col-auto" style="width: 550px;">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input name="luggage" type="text" class="form-control" id="select4" disabled="disabled" value='<?php if(isset($_SESSION['l'])){ echo $_SESSION['l']; }?>' placeholder="Luggage Inavailable" >
                                    </div>
                                </div>
                                <div class="col-auto" style="width: 550px;">
                                    <label class="sr-only" for="inlineFormInputGroup"></label>
                                    <div class="input-group mb-2">
                                            <button class="btn btn-primary mb-2"  name="submit" id="btnn" type="submit" disabled="disabled" onClick = "this.style.visibility= 'hidden';"  style="background-color: rgb(221, 236, 81);color: black;width: 520px;border: none;">Calculate Fare</button>
                                    </div>
                                    <div style="background-color: rgb(137, 137, 226); border-radius: 20px;">
                                        ...
                                        <?php 
                                              ...
                                              { echo "Total Fare ₹ :  " .$_SESSION['f']; 
                                                echo "</br>"; 
                                              }
                                              if(isset($_SESSION['f']))
                                              { echo "Total Distance :  " .$_SESSION['td']; 
                                              }
                                             ?>
