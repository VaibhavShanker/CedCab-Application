...
<div class="row mt-3">
    ...
    <div class="col-md-4 col-sm-4 col-lg-4 col-xs-4 text-center">
        ...
        <center>
            ...
            <a href="#"><i class="fab fa-twitter-square" style="padding: 30px; font-size: 30px;"></i></a>
            <a href="#"><i class="fab fa-instagram-square" style="padding: 20px; font-size: 30px;"></i></a>
