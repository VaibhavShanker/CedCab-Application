                    ...
                    <ul class="nav navbar-nav">
                         <li><a href="../homeuser.php">User Dashboard</a></li>
                            ...
                            <li class="active"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Ride </span></a>
                                ...
                                <li class="active"><a href="completed_ride_user.php">Completed Rides</a></li> 
            ...
            <?php
                ...
                require 'css.php';
                    ...
                    while($row = mysqli_fetch_array($result)) {
                        ...
                        echo "<td> <a  class='btn btn-primary' href=print_inv.php?id=".$row["ride_id"].">Invoice</a> </td>";                 
                        echo "</tr>";
                        }
                    echo "</table>";
                    mysqli_close($con);
