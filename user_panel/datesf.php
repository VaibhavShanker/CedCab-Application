                ...
                <div class="container-fluid">
                    ...
                    <li><a href="../homeuser.php">User Dashboard</a></li>
                            ...
                            <li class="active"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Ride </span></a>
                                ...
                                <li class="active"><a href="pending_ride_user.php">Pending Rides</a></li>
        ...
        <div class="container-fluid section2a" style="background: none;padding-top: 0px;">
            ...
            <div class="container">
                  <div class="dropdown">
                      ...
                      <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="../user_panel/pending_ride_user.php" onclick="loadDoc1()">Date. Ascending </a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="../user_panel/pending_ride_user.php" onclick="loadDoc1()">Date. Descending </a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="../user_panel/completed_ride_user.php" onclick="loadDoc2()">Fare. Descending</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="../user_panel/Canceled_ride_user.php" onclick="loadDoc3()">Distance</a></li>
                       <li role="presentation" class="divider"></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="../user_panel/all_ride_user.php">All Rides</a></li>   
                      </ul>
                  </div>
