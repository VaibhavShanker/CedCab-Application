                ...
                <div class="card-body p-0">
                    <div class="row p-5">
                        ...
                        <div class="col-md-6 text-right">                 
                            ...
                            <a href="../user_panel/completed_ride_user.php">Go Back</a>
                        ...
                        <div class='col-md-6 text-right'>
                            <?php 
                                    ...
                                    while($row = mysqli_fetch_array($result)) {                                          
                                            ...
                                            echo "<p class='mb-1'><span class='text-muted'>Custmer Id: </span>" . $row['customer_user_id'] ."</p>";
                                            // echo "<p class='mb-1'><span class='text-muted'>Custmer Id: </span>" . $row['name'] ."</p>";
                                            echo "<p class='mb-1'><span class='text-muted'>Ride Date : </span>". $row['ride_date'] ."</p>";
                                    }
                            ?>
                    </div>
                    </div>
